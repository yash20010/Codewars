...
function driver(data) {
  ...
  m = months.indexOf(m.toLowerCase().slice(0, 3)) + 1
  return `${ln.slice(0, 5).padEnd(5, '9').toUpperCase()}${y[2]}${
    g === 'M' ? String(m).padStart(2, '0') : String(m + 50)
  }${d}${y.slice(-1)}${mn === '' ? fn[0] + '9' : fn[0] + mn[0]}9AA`
}
